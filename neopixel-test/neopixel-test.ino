...
void loop() {
  ...
  // colorWipe(strip.Color(16, 0, 0), 50); // Red
  // colorWipe(strip.Color(0, 16, 0), 50); // Green
  // colorWipe(strip.Color(0, 0, 16), 50); // Blue
  emblemLoop(100, purple); // slow change, sorta 

}

void emblemLoop(uint8_t wait, uint32_t c) {
